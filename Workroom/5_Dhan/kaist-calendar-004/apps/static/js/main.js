                        ...
                        '<div class="modal-body">'+
                            '<form class="form-horizontal" role="form">'+
                                '<div class="form-group">'+ // title
                                    ...
                                    '<div class="col-lg-10">'+
                                        '<input type="text" class="form-control" id="input_Title" placeholder="제목을 적어주세요.">'+
                                    '</div>'+
                                '</div>'+
                                '<div class="form-group">'+ // title_cal
                                    '<label for="input_Title_cal" class="col-lg-2 control-label">짧은 제목</label>'+
                                    '<div class="col-lg-10">'+
                                        '<input type="text" class="form-control" id="input_Title_cal" placeholder="달력에 표시될 제목입니다. 15자 내로 적어주세요.">'+
                                    '</div>'+
                                '</div>'+
                                '<div class="form-group">'+ // content
                                    '<label for="input_Content" class="col-lg-2 control-label">소개</label>'+
                                    '<div class="col-lg-10">'+
                                        '<textarea class="form-control" id="input_Content" rows="10" placeholder="이벤트 소개 부탁드립니다."></textarea>'+
                                    '</div>'+
                                '</div>'+
                                '<div class="form-group">'+ // host
                                    '<label for="input_Host" class="col-lg-2 control-label">주최</label>'+
                                    '<div class="col-lg-10">'+
                                        '<input type="text" class="form-control" id="input_Host" placeholder="주최자 또는 주최단체">'+
                                    '</div>'+
                                '</div>'+
                                ...
                                '<div class="form-group">'+ // date_start
                                    ...
                                    '<div class="col-lg-10">'+
                                        '<div class="input-group date" id="datetimepicker1">'+
                                            '<input type="datetime" class="form-control" id="input_Date_start"/>'+
                                ...
                                '<div class="form-group">'+ // date_end
                                    ...
                                    '<div class="col-lg-10">'+
                                        '<div class="input-group date" id="datetimepicker2">'+
                                            '<input type="datetime" class="form-control" id="input_Date_end"/>'+
                                            '<span class="input-group-addon"><span class="glyphicon-calendar glyphicon"></span>'+
                                            '</span>'+
                                        '</div>'+
                                    '</div>'+
                                ...
                                '<div class="form-group">'+ // location
                                    ...
                                    '<div class="col-lg-10">'+
                                        '<input type="text" class="form-control" id="input_Location" placeholder="이벤트 장소는 어디인가요?">'+
                                    '</div>'+
                                '</div>'+
                                '<div class="form-group">'+ // link
                                    '<label for="input_Link" class="col-lg-2 control-label">링크</label>'+
                                    '<div class="col-lg-10">'+
                                        '<input type="url" class="form-control" id="input_Link" placeholder="관련 정보 url">'+
                                    '</div>'+
                                '</div>'+
                                '<div class="form-group">'+ // poster
                                    '<label for="input_Poster" class="col-lg-2 control-label">포스터 링크</label>'+
                                    '<div class="col-lg-10">'+
                                        '<input type="url" class="form-control" id="input_Poster" placeholder="이미지 파일 url">'+
                                    '</div>'+
                                '</div>'+
                                '<div class="form-group">'+ // contact
                                    '<label for="input_Contact" class="col-lg-2 control-label">Email</label>'+
                                    '<div class="col-lg-10">'+
                                        '<input type="email" class="form-control" id="input_Contact" placeholder="연락가능한 Email">'+
                                    '</div>'+
                                '</div>'+
