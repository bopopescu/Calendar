...
def sell_list():
    context = {}
    context['sell_list'] = Event.query.filter_by(category_char='sell')
    return render_template("category/sell.html", context=context)


@app.route('/sell', methods=['GET'])
def comp_list():
    context = {}
    context['comp_list'] = Event.query.filter_by(category_char='comp')
    return render_template("category/sell.html", context=context)
